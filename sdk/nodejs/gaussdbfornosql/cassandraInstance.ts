...
export class CassandraInstance extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CassandraInstanceState, opts?: pulumi.CustomResourceOptions): CassandraInstance {
        return new CassandraInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'huaweicloud:GaussDBforNoSQL/cassandraInstance:CassandraInstance';

    /**
     * Returns true if the given object is an instance of CassandraInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CassandraInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CassandraInstance.__pulumiType;
    }
     ...
     */
    public readonly datastore!: pulumi.Output<outputs.GaussDBforNoSQL.CassandraInstanceDatastore>;
    /**
    ...
    /**
     * Create a CassandraInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CassandraInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CassandraInstanceArgs | CassandraInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CassandraInstanceState | undefined;
            ...
            const args = argsOrState as CassandraInstanceArgs | undefined;
        ...
        super(CassandraInstance.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface CassandraInstanceState {
     ...
     * this parameter will create a new resource.
     */
    datastore?: pulumi.Input<inputs.GaussDBforNoSQL.CassandraInstanceDatastore>;
    /**
     * Indicates the default username.
     */
