 ...
 *
 * const test = pulumi.output(huaweicloud.GaussDBforNoSQL.getRedisInstance({
...
export function getRedisInstance(args?: GetRedisInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetRedisInstanceResult> {
    ...
    return pulumi.runtime.invoke("huaweicloud:GaussDBforNoSQL/getRedisInstance:getRedisInstance", {
        "name": args.name,
        "region": args.region,
...
export interface GetRedisInstanceResult {
     ...
     */
    readonly backupStrategies: outputs.GaussDBforNoSQL.GetRedisInstanceBackupStrategy[];
    /**
     * Indicates the database information. Structure is documented below.
     */
    readonly datastores: outputs.GaussDBforNoSQL.GetRedisInstanceDatastore[];
    /**
     ...
     */
    readonly nodes: outputs.GaussDBforNoSQL.GetRedisInstanceNode[];
    /**
...
export function getRedisInstanceOutput(args?: GetRedisInstanceOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRedisInstanceResult> {
    return pulumi.output(args).apply(a => getRedisInstance(a, opts))
}
