 ...
 * ```
 */
export class MongoInstance extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MongoInstanceState, opts?: pulumi.CustomResourceOptions): MongoInstance {
        return new MongoInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'huaweicloud:GaussDBforNoSQL/mongoInstance:MongoInstance';

    /**
     * Returns true if the given object is an instance of MongoInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MongoInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MongoInstance.__pulumiType;
    }
     ...
     */
    public readonly backupStrategy!: pulumi.Output<outputs.GaussDBforNoSQL.MongoInstanceBackupStrategy>;
    /**
     ...
     */
    public readonly datastore!: pulumi.Output<outputs.GaussDBforNoSQL.MongoInstanceDatastore>;
    /**
     ...
     */
    public /*out*/ readonly nodes!: pulumi.Output<outputs.GaussDBforNoSQL.MongoInstanceNode[]>;
    /**
    ...
    constructor(name: string, argsOrState?: MongoInstanceArgs | MongoInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MongoInstanceState | undefined;
            ...
            const args = argsOrState as MongoInstanceArgs | undefined;
        ...
        super(MongoInstance.__pulumiType, name, resourceInputs, opts);
    }
}
