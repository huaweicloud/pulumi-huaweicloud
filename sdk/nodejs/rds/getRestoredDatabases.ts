 ...
 * const test = huaweicloud.Rds.getRestoredDatabases({
 *     engine: "postgresql",
 ...
 * ```
 */
export function getRestoredDatabases(args: GetRestoredDatabasesArgs, opts?: pulumi.InvokeOptions): Promise<GetRestoredDatabasesResult> {
    if (!opts) {
        opts = {}
    }

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    return pulumi.runtime.invoke("huaweicloud:Rds/getRestoredDatabases:getRestoredDatabases", {
 ...
 */
export interface GetRestoredDatabasesArgs {
    /**
 ...
 */
export interface GetRestoredDatabasesResult {
    /**
     ...
     */
    readonly instances: outputs.Rds.GetRestoredDatabasesInstance[];
...
export function getRestoredDatabasesOutput(args: GetRestoredDatabasesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRestoredDatabasesResult> {
    return pulumi.output(args).apply(a => getRestoredDatabases(a, opts))
}

/**
 * A collection of arguments for invoking getRestoredDatabases.
 */
export interface GetRestoredDatabasesOutputArgs {
    /**
     * Specifies the database name, which can be used for fuzzy query.
     */
