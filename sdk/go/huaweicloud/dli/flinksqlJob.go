...
type FlinksqlJob struct {
	...
	GraphType pulumi.StringPtrOutput `pulumi:"graphType"`
	...
	// JSON format.
	OperatorConfig pulumi.StringPtrOutput `pulumi:"operatorConfig"`
	...
	StaticEstimator pulumi.BoolPtrOutput `pulumi:"staticEstimator"`
	// Specifies the traffic or hit rate configuration of each operator, in
	// JSON format.
	StaticEstimatorConfig pulumi.StringPtrOutput `pulumi:"staticEstimatorConfig"`
	// The Job status.
	Status pulumi.StringOutput `pulumi:"status"`
	// The simplified stream graph or static stream graph information of the Flink SQL job.
	StreamGraph pulumi.StringOutput `pulumi:"streamGraph"`
...
type flinksqlJobState struct {
	...
	// Specifies degree of parallelism (DOP) configuration of an operator, in
	// JSON format.
	OperatorConfig *string `pulumi:"operatorConfig"`
	// Specifies number of parallel for a job. The default value is 1.
	...
	// Specifies whether to estimate static resources. Default value is `false`.
	StaticEstimator *bool `pulumi:"staticEstimator"`
	// Specifies the traffic or hit rate configuration of each operator, in
	// JSON format.
	StaticEstimatorConfig *string `pulumi:"staticEstimatorConfig"`
	// The Job status.
	Status *string `pulumi:"status"`
	// The simplified stream graph or static stream graph information of the Flink SQL job.
	StreamGraph *string `pulumi:"streamGraph"`
	// Specifies the key/value pairs to associate with the resource.
...
type FlinksqlJobState struct {
	...
	// Specifies degree of parallelism (DOP) configuration of an operator, in
	// JSON format.
	OperatorConfig pulumi.StringPtrInput
	// Specifies number of parallel for a job. The default value is 1.
	...
	// Specifies whether to estimate static resources. Default value is `false`.
	StaticEstimator pulumi.BoolPtrInput
	// Specifies the traffic or hit rate configuration of each operator, in
	// JSON format.
	StaticEstimatorConfig pulumi.StringPtrInput
	// The Job status.
	Status pulumi.StringPtrInput
	// The simplified stream graph or static stream graph information of the Flink SQL job.
	StreamGraph pulumi.StringPtrInput
	// Specifies the key/value pairs to associate with the resource.
...
// Specifies the version of the flink.
// The valid values are `1.10` and `1.12`, defalut value is `1.10`.
func (o FlinksqlJobOutput) FlinkVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FlinksqlJob) pulumi.StringPtrOutput { return v.FlinkVersion }).(pulumi.StringPtrOutput)
}

// Specifies the type of stream graph to be generated by the Flink SQL job.
// The valid values are `simpleGraph` and `jobGraph`. The default value is `simpleGraph`.
func (o FlinksqlJobOutput) GraphType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FlinksqlJob) pulumi.StringPtrOutput { return v.GraphType }).(pulumi.StringPtrOutput)
}
...
// Specifies degree of parallelism (DOP) configuration of an operator, in
// JSON format.
func (o FlinksqlJobOutput) OperatorConfig() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FlinksqlJob) pulumi.StringPtrOutput { return v.OperatorConfig }).(pulumi.StringPtrOutput)
}
...
// Specifies whether to estimate static resources. Default value is `false`.
func (o FlinksqlJobOutput) StaticEstimator() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *FlinksqlJob) pulumi.BoolPtrOutput { return v.StaticEstimator }).(pulumi.BoolPtrOutput)
}

// Specifies the traffic or hit rate configuration of each operator, in
// JSON format.
func (o FlinksqlJobOutput) StaticEstimatorConfig() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FlinksqlJob) pulumi.StringPtrOutput { return v.StaticEstimatorConfig }).(pulumi.StringPtrOutput)
}
...
// The simplified stream graph or static stream graph information of the Flink SQL job.
func (o FlinksqlJobOutput) StreamGraph() pulumi.StringOutput {
	return o.ApplyT(func(v *FlinksqlJob) pulumi.StringOutput { return v.StreamGraph }).(pulumi.StringOutput)
}
