...
func NewGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.RegisterResource("huaweicloud:SharedApig/group:Group", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.ReadResource("huaweicloud:SharedApig/group:Group", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o GroupOutput) Status() pulumi.IntOutput {
	return o.ApplyT(func(v *Group) pulumi.IntOutput { return v.Status }).(pulumi.IntOutput)
}
