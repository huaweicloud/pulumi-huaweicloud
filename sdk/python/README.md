...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `huaweicloud` with the `NAME` of your provider.
...
- binary: pulumi-resource-huaweicloud
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-huaweicloud/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-huaweicloud_darwin_amd64_v1
│   └── pulumi-resource-huaweicloud
├── pulumi-huaweicloud_darwin_arm64
│   └── pulumi-resource-huaweicloud
├── pulumi-huaweicloud_linux_amd64_v1
│   └── pulumi-resource-huaweicloud
├── pulumi-huaweicloud_linux_arm64
│   └── pulumi-resource-huaweicloud
├── pulumi-huaweicloud_windows_amd64_v1
│   └── pulumi-resource-huaweicloud.exe
└── pulumi-huaweicloud_windows_arm64
    └── pulumi-resource-huaweicloud.exe
```
