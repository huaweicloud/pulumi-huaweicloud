...
class MysqlDatabasePrivilege(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 instance_id: Optional[pulumi.Input[str]] = None,
                 region: Optional[pulumi.Input[str]] = None,
                 users: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MysqlDatabasePrivilegeUserArgs']]]]] = None,
                 __props__=None):
        """
        ...
        test = huaweicloud.rds.MysqlDatabasePrivilege("test",
            ...
            db_name=db_name,
            users=[
                huaweicloud.rds.MysqlDatabasePrivilegeUserArgs(
                    name=user_name1,
                    readonly=True,
                ),
                huaweicloud.rds.MysqlDatabasePrivilegeUserArgs(
        ...
        :param pulumi.Input[str] region: The region in which to create the RDS database privilege resource. If omitted,
               the provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MysqlDatabasePrivilegeUserArgs']]]] users: Specifies the account that associated with the database. Structure is documented below.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[str]] = None,
            region: Optional[pulumi.Input[str]] = None,
            users: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MysqlDatabasePrivilegeUserArgs']]]]] = None) -> 'MysqlDatabasePrivilege':
        """
