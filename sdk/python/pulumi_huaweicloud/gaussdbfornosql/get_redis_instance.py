...
def get_redis_instance(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_redis_instance)
def get_redis_instance_output(name: Optional[pulumi.Input[Optional[str]]] = None,
